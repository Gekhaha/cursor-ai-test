...
@onready var dialog_progress_indicator: PanelContainer = $DialogUI/DialogProressIndicator
@onready var dialog_progress_indicator_label: Label = $DialogUI/DialogProressIndicator/Label
