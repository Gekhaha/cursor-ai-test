...
const ERROR = preload("res://GUI/shop_menu/error.wav")
const OPEN_SHOP = preload("res://GUI/shop_menu/open_shop.wav")
const PURCHASE = preload("res://GUI/shop_menu/purchase.wav")
...
func update_item_dchanged(item: ItemData) -> void:
